    ...
    >
      ...
      >
        ...
        <p style={{ margin: 0, maxWidth: 760, color: "var(--text-muted)", lineHeight: 1.8 }}>
          Estamos disponibles para ayudarte con talles, stock y consultas por WhatsApp. Si quieres
          informacion del punto de venta o retiro, escribenos y te pasamos todos los detalles.
        </p>
      </div>
    </section>
  );
