...
let WebhookDeliveryProcessor = class WebhookDeliveryProcessor extends bullmq_1.WorkerHost {
    prisma;
    constructor(prisma) {
        super();
        this.prisma = prisma;
...
exports.WebhookDeliveryProcessor = WebhookDeliveryProcessor = __decorate([
